...
2. Use EXACT Git source URL from catalog (character-by-character, GitHub username is "ChannalKishor")
...
2. Copy source URL exactly (verify username is "ChannalKishor")
3. Map all JSON attributes to module variables
4. Generate module block with proper indentation

**IMPORTANT RULE:**
All Terraform modules must use the GitHub organization/repository owner:ChannalKishor

Never generate module sources using any other GitHub owner.Correct module source format:

git::https://github.com/ChannalKishor/<module-repo>.git?ref=main
...
- repo_name: "ChannalKishor/terraform-agent-poc-dev"
